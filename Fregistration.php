...
<html lang="en">
    ...
    <body>
        <div class="d-flex justify-content-center align-items-center login-container form-row">
            <form class="login-form text-center" onsubmit="return validate();" action="controllers/f_reg.php" method="POST" enctype="multipart/form-data">
                <h2 class="mb-5 font-weight-light">Freelancer's Registration</h2>
                ...
                <div class="form-group">
                    <input type="text" class="form-control rounded-pill form-control-lg" id="skills" name="skills" placeholder="Skills (Ex: Graphics Design, Photo Editing,...)">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control rounded-pill form-control-lg" id="plink" name="plink" placeholder="Portfolio Link (Optional)">
                </div>
                <div class="form-group">
